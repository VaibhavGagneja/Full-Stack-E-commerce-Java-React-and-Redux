...
import com.commerce.e_commerce.domain.PaymentStatus;
import com.commerce.e_commerce.model.*;
import com.commerce.e_commerce.repository.AddressRespository;
import com.commerce.e_commerce.repository.OrderItemRepository;
import com.commerce.e_commerce.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Set<Order> createOrder(User user, Address shippingAddress, Cart cart) throws Exception {
        ...
        Address address = addressRespository.save(shippingAddress);
    ...
    public Order cancelOrder(Long orderId, User user) throws Exception {
        ...
        if(!user.getId().equals(order.getUser().getId())) {
            throw new Exception("order can't cancel, you do not have access");
        }
